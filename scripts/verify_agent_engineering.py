...
from agent.loop import run, _dispatch
from agent.prompts import faithfulness_prompt
from core.citations import check_faithfulness, verify_citations
...
def test_context_contract_excluded():
    # 合同消息不传给 build_history（main.py 单独 _history_with_contract 追加）——
