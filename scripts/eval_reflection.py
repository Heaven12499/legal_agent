...
用法: python -X utf8 scripts/eval_reflection.py [--dry] [--runs N]
"""
import argparse
import sys
...
sys.path.insert(0, str(Path(__file__).resolve().parent))  # 供 import eval_review

from eval_review import CASES, _validate_gold, _fmt_pair, _fmt_pct
